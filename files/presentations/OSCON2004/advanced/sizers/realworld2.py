...
"""
This sample is more of a real world exampel of using sizers with
controls, nested sizers, borders, alignment, etc.
"""
...
class TestFrame(wx.Frame):
    def __init__(self):
        ...
        notesLbl = wx.StaticText(panel, -1, "Notes:")
        notes = wx.TextCtrl(panel, -1, "", style=wx.TE_MULTILINE)
        ...
        addrSizer.Add(notesLbl, 0, wx.ALIGN_RIGHT|wx.ALIGN_TOP)
        addrSizer.Add(notes, 0, wx.EXPAND)
        addrSizer.AddGrowableRow(6)
