...
IRC channels at [freenode.net](https://freenode.net). If you are not
...
You can learn more about IRC at [IRC Help](https://www.irchelp.org/).  You
may also want to read [this](https://wxwidgets.org/support/irc/).  If you expect
to be using IRC more than just once or twice then registering your nickname
is a good idea. See the
[Freenode FAQ](https://wiki.freenode.net/view/Main_Page#FAQ) for details.
